...
exports['jschecker'] = {
  ...
  'test empty file' : function(test) {
    ...
    jschecker.inspect(files, null, {}, function(reports) {
  ...
  'test overview report structure' : function(test) {
    ...
    jschecker.inspect(files, null, {}, function(reports) {
      var overview = jschecker.getOverviewReport(reports);
  ...
  'test noempty line option' : function(test) {
    ...
    jschecker.inspect(files, null, {noempty : true}, function(reports) {
      var overview = jschecker.getOverviewReport(reports);
